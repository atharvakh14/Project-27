...
function setup() {
	...
	roof = new Roof(200, 250, 100, 20);

	bobObject1 = new Bob(160, 450, 10);
	bobObject2 = new Bob(180, 450, 10);
	bobObject3 = new Bob(200, 450, 10);
	bobObject4 = new Bob(220, 450, 10);
	bobObject5 = new Bob(240, 450, 10);
